...
HD_PWD='E:/Repository/SEU-ASIC-IOT-ECGAI/ECGAI_ver_3_0/accelerator/proj/ECGAI_ver_3_0/ECGAI_ver_3_0.runs/weg_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weg_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weg_mem.tcl
