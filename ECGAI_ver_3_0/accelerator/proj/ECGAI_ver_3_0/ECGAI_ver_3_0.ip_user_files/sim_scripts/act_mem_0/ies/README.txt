...
#
# Generated by export_simulation on Mon Jun 05 19:26:45 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './act_mem_0.sh' script.

./act_mem_0.sh -reset_run
...
./act_mem_0.sh -noclean_files

For more information on the script, please type './act_mem_0.sh -help'.
