...
#
# Generated by export_simulation on Mon Jun 05 17:01:23 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './act_mem_1.sh' script.

./act_mem_1.sh -reset_run
...
./act_mem_1.sh -noclean_files

For more information on the script, please type './act_mem_1.sh -help'.
