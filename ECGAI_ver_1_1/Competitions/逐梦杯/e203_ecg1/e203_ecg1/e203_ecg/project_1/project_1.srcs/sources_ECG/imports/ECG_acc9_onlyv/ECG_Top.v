...
module ECG_Top(
				...
				//======================================================================================	
					...
					output					FC_OVld,
					output  wire [7:0]     weight_data_O0,
					output  wire [7:0]     weight_data_O1,
					output wire			[13:0]			wt_I_addr_sf,
					output wire			[8:0]			wr_addr_sf,
					output wire	 	 	[7:0]			IOB_Data_O0_sf,
					output wire	 	 	[7:0]			IOB_Data_O1_sf,
					output wire        [13:0]          wt_C0_addr_sf,
					output wire        [13:0]          wt_C1_addr_sf,
					output wire   			[8:0]  		rd_addr_sf,
					output wire                        SPI_start_temp,
					
				/*	output wire [7:0] sf_addr_reg0,
                    output wire [7:0] sf_addr_reg1,
                    output wire [7:0] sf_addr_reg2,
                    output wire [7:0] sf_addr_reg3,
                    output wire [7:0] sf_addr_reg4,
                    
                    output wire [7:0] sf_reg0,
                    output wire [7:0] sf_reg1,
                    output wire [7:0] sf_reg2,
                    output wire [7:0] sf_reg3,
                    output wire [7:0] sf_reg4,
                    
                    					output wire [7:0] sf_maddr_reg0,
                    output wire [7:0] sf_maddr_reg1,
                    output wire [7:0] sf_maddr_reg2,
                    output wire [7:0] sf_maddr_reg3,
                    output wire [7:0] sf_maddr_reg4,
                    
                    output wire [7:0] sf_mreg0,
                    output wire [7:0] sf_mreg1,
                    output wire [7:0] sf_mreg2,
                    output wire [7:0] sf_mreg3,
                    output wire [7:0] sf_mreg4,*/
                    
                    output wire [31:0] SF_FC_REG1,
                    output wire [31:0] SF_FC_REG2,
                    output wire [31:0] SF_FC_REG3,
                    output wire [31:0] SF_FC_REG4,
                    output wire [7:0] SF_FC_REG5,
                    
                    
                    input wire Enable_trans,
                    output wire Busy,
                    input wire [7:0] w_weight,
                    output wire enable_rise_reg,
                    output wire enable_rise,
                    output wire  wait_tran,
                    output wire final_flag,
                    output wire tran_start
                    
                    
                    
                    
					//output  reg [3:0]      nn_layer_cnt_temp
					//output  wire [7:0]     weight_data_O1,
					//output  wire [7:0]     weight_data_O2
			);
 	//====================================================================== Configurator ==========================================================================
	...
	wire 		 	[7:0] 		    weight_data_O3,weight_data_O4, weight_data_O5, weight_data_O6, weight_data_O7;	
   // wire 		 	[7:0] 			weight_data_O0;
    //wire 		 	[7:0] 			weight_data_O1;
    wire 		 	[7:0] 			weight_data_O2;
	...
	wire							PE_OMapVld1_sf, PE_OMapVld2_sf, PE_OMapVld3_sf, PE_OMapVld4_sf,
									PE_OMapVld5_sf, PE_OMapVld6_sf, PE_OMapVld7_sf, PE_OMapVld8_sf;
	// Signals with IOB(FC)
	...
	//============================================================================================================================================================
	assign wt_I_addr_sf = wt_I_addr;
	assign wr_addr_sf = wr_addr;          //9bits
	assign IOB_Data_O0_sf = IOB_Data_O0;  //8bits
	assign IOB_Data_O1_sf = IOB_Data_O1;  //8bits
	assign wt_C0_addr_sf = wt_C0_addr;  //14bits weight addr
	assign wt_C1_addr_sf = wt_C1_addr;  //14bits weight addr
	assign rd_addr_sf = rd_addr;       //9bits inout addr
	...
	PEarray16_8
		u_pearray16_8(
						...
						.PE_OMap7				( PE_OMap7				),
						.PE_OMap8				( PE_OMap8				),
						.PE_OMapVld1_sf			( PE_OMapVld1_sf			),
						.PE_OMapVld2_sf			( PE_OMapVld2_sf			),
						.PE_OMapVld3_sf			( PE_OMapVld3_sf			),
						.PE_OMapVld4_sf			( PE_OMapVld4_sf			),
						.PE_OMapVld5_sf			( PE_OMapVld5_sf			),
						.PE_OMapVld6_sf			( PE_OMapVld6_sf			),
						.PE_OMapVld7_sf			( PE_OMapVld7_sf			),
						.PE_OMapVld8_sf			( PE_OMapVld8_sf			),
						.PE_end					( pe_end				),
						//FC
						.FC_OMap1				( FC_OMap1				),
						.FC_OMap2				( FC_OMap2				),
	...
	Relu8
		u_relu8(
						...
						.Relu_Din7				(PE_OMap7),	
						.Relu_Din8				(PE_OMap8),	
						.Relu_Din_vld1				(PE_OMapVld1_sf),
						.Relu_Din_vld2				(PE_OMapVld2_sf),
						.Relu_Din_vld3				(PE_OMapVld3_sf),
						.Relu_Din_vld4				(PE_OMapVld4_sf),
						.Relu_Din_vld5				(PE_OMapVld5_sf),
						.Relu_Din_vld6				(PE_OMapVld6_sf),
						.Relu_Din_vld7				(PE_OMapVld7_sf),
						.Relu_Din_vld8				(PE_OMapVld8_sf),
						.Relu_max				(Relu_max[1]),
