...
#
# Generated by export_simulation on Mon Nov 29 14:57:30 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './weight_mem_gen_30.sh' script.

./weight_mem_gen_30.sh -reset_run
...
./weight_mem_gen_30.sh -noclean_files

For more information on the script, please type './weight_mem_gen_30.sh -help'.
