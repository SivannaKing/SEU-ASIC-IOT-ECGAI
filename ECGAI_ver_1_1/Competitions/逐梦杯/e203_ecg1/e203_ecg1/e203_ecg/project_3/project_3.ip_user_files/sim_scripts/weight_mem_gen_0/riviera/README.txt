...
#
# Generated by export_simulation on Tue Sep 28 13:48:41 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './weight_mem_gen_0.sh' script.

./weight_mem_gen_0.sh -reset_run
...
./weight_mem_gen_0.sh -noclean_files

For more information on the script, please type './weight_mem_gen_0.sh -help'.
