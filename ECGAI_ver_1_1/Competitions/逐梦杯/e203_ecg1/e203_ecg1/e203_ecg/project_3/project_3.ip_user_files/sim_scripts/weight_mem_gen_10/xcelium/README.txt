...
#
# Generated by export_simulation on Mon Nov 29 14:55:34 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './weight_mem_gen_10.sh' script.

./weight_mem_gen_10.sh -reset_run
...
./weight_mem_gen_10.sh -noclean_files

For more information on the script, please type './weight_mem_gen_10.sh -help'.
