...
#
# Generated by export_simulation on Tue Sep 28 13:48:33 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './map_mem_gen_6.sh' script.

./map_mem_gen_6.sh -reset_run
...
./map_mem_gen_6.sh -noclean_files

For more information on the script, please type './map_mem_gen_6.sh -help'.
