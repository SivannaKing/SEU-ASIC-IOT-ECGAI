...
#
# Generated by export_simulation on Mon Nov 29 15:02:06 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './weight_mem_gen_60.sh' script.

./weight_mem_gen_60.sh -reset_run
...
./weight_mem_gen_60.sh -noclean_files

For more information on the script, please type './weight_mem_gen_60.sh -help'.
