...
create_clock -add -name sys_clk_pin -period 40.00 -waveform {0 20} [get_ports {CLK100MHZ}];
...
#create_clock -add -name sys_clk_pin -period 2000.00 -waveform {0 1000} [get_ports {CLK32768KHZ}];
