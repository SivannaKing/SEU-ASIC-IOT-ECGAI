...
from utils.model import ECG_XNOR_Full
...
A = [[1,           8,           kernel_size,       2,       padding,       padding_value,       poolsize,        2],
     ...
     [32,         48,           kernel_size,       1,       padding,       padding_value,       poolsize,        2],
     [48,         classes_num,  kernel_size,       1,       padding,       padding_value,       poolsize,        2],
     ]


model = ECG_XNOR_Full(block1=A[0], block2=A[1], block3=A[2], block4=A[3],
...
#writer=create_writer(experiment_name='3th_12.02_BinNet_exp_5k_epoch_padding+-1_batch-size_32_lr_5e-3',model_name=model.name,extra=f"{num_epochs}_epochs"
# save_filepath = f"ECG_Net_pretrained_float_for_{classes}.pth"
